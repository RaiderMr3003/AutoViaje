...
<body>
            ...
            <div class="card-body">
                ...
                <form action="guardar_auto.php" method="post" class="row g-3" autocomplete="off">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="tiempo-de-viaje" name="tiempo-de-viaje">
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" name="observaciones" id="observaciones" style="resize: none; field-sizing: content;"></textarea>
                    </div>
    ...
    <script>
        ...
        document.querySelector("form").addEventListener("submit", function(event) {
            ...
            let tiempoViaje = document.getElementById("tiempo-de-viaje").value;
            ...
            if (tiempoViaje === "") errores.push("Debe ingresar el tiempo de viaje");
